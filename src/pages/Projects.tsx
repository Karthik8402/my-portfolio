        ...
        {filteredProjects.length > 6 && !showAll && (
          ...
          >
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 border border-dashed border-slate-300 dark:border-slate-700 rounded-xl text-sm text-slate-600 dark:text-slate-400 hover:border-primary hover:text-primary dark:hover:border-primary dark:hover:text-primary transition-all hover:-translate-y-0.5"
            >
